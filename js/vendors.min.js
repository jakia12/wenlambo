        ...
        function prefillYear(dateParts, currentResult, opts) {
          if (dateParts.year !== dateParts.rawyear) {
            ...
            if (2 === enteredPart.length && enteredPart === currentYearPart) {
              ...
              dateParts.day === entryCurrentYear.getDay() &&
                (!opts.max ||
...
let prewiiewBtn = document.querySelector(".prewiiew__btn button");
let prewiiew = document.querySelector(".prewiiew");
let audio = document.querySelector("audio");
prewiiewBtn.addEventListener("click", function () {
  audio.play();
  prewiiew.classList.add("_hide");
});

let homeSound = document.querySelector(".home__sound");
homeSound.addEventListener("click", function () {
  if (audio.muted) {
    audio.muted = false;
  } else {
    audio.muted = true;
